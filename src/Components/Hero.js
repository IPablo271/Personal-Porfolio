...
const Hero = () => {
  return (
    ...
    lg:bg-no-repear py-32 lg:py-0 overflow-hidden'>
            ...
            <div className='flex items-center h-full pt-8'>
              <div className='flex-1 flex flex-col items-center lg:items-start'>
                <p className='text-lg text-accent text-md mb-[22px]'>
                  ...
                  text-lg text-center lg:text-left'>
                    I am currently studying computer science engineering at the Universidad del Valle de Guatemala, 
                    some of my favorite activities are programming web pages, playing soccer and listening to music
                  </p>
